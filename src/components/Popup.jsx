  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between pb-5 border-b border-b-primaryColor">
        ...
        <p className="text-lg text-white font-medium"> {safeString(2,true)} {network() ? network().toLowerCase() == "sepolia" ? "Minutes": "Months" : " Connect Wallet "}</p>
      </div>
      ...
      <div className="items-center justify-between py-5 border-b border-b-primaryColor">
        ...
        Payouts Every:  
        {network() ? network().toLowerCase() == "sepolia" ? " 10 Minutes": " 1 Month" : " Connect Wallet "}</p>
